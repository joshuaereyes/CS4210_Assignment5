...
# SPECIFICATION: Finds support and confidence for each association rule using various libraries
...
#use the gain formula provided right after
    supportCount =rules["consequent support"][i] * len(encoded_vals)
